...
async def test_check_health_mean_fitness(store: TraceStore, monitor: SystemMonitor):
    f1 = FitnessScore(correctness=1.0, dharmic_alignment=1.0, elegance=1.0, efficiency=1.0, safety=1.0)
    f2 = FitnessScore(correctness=0.5, dharmic_alignment=0.5, elegance=0.5, efficiency=0.5, safety=0.5)
