...
source:
  ...
  cited_urls:
  - https://github.com/yourusername/dharma_swarm.git
...
- dharma_swarm.jikoku_instrumentation
...
pkm:
  ...
  vault_path: docs/architecture/PRODUCTION_DEPLOYMENT_GUIDE.md
  retrieval_terms:
  - production
  - deployment
  - guide
...
stigmergy:
  ...
  levels:
    sematectonic:
      ...
      access_mark: Opening, linking, and revising docs/architecture/PRODUCTION_DEPLOYMENT_GUIDE.md reinforces its salience without needing a separate message.
    marker_based:
