...
path: docs/architecture/COMPLIANCE_MAPPING.md
slug: compliance-framework-mapping
doc_type: documentation
status: active
summary: 'Date : 2026-03-09 Purpose : Map dharma swarm telos gates to regulatory/certification requirements Status : dharma swarm is 60-85% aligned with major frameworks'
source:
...
pkm:
  ...
  vault_path: docs/architecture/COMPLIANCE_MAPPING.md
  retrieval_terms:
  - compliance
  - mapping
  - framework
...
stigmergy:
  ...
  state: working
  semantic_weight: 0.6
  coordination_comment: 'Date : 2026-03-09 Purpose : Map dharma swarm telos gates to regulatory/certification requirements Status : dharma swarm is 60-85% aligned with major frameworks'
  levels:
    sematectonic:
      what_it_is: The document itself is the mark. Its existence, filename, location, and revision history attract or repel future work.
      access_mark: Opening, linking, and revising docs/architecture/COMPLIANCE_MAPPING.md reinforces its salience without needing a separate message.
    marker_based:
