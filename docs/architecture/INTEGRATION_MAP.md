---
title: 'Integration Map: Proven Systems → Dharma Swarm'
path: docs/architecture/INTEGRATION_MAP.md
slug: integration-map-proven-systems-dharma-swarm
doc_type: note
status: active
summary: 'Date : 2026-03-08 Purpose : Map existing infrastructure to world-class verification systems'
source:
...
pkm:
  note_class: note
  vault_path: docs/architecture/INTEGRATION_MAP.md
  retrieval_terms:
  - integration
  - map
  - proven
...
stigmergy:
  ...
  state: active
  semantic_weight: 0.6
  coordination_comment: 'Date : 2026-03-08 Purpose : Map existing infrastructure to world-class verification systems'
  levels:
    sematectonic:
      what_it_is: The document itself is the mark. Its existence, filename, location, and revision history attract or repel future work.
      access_mark: Opening, linking, and revising docs/architecture/INTEGRATION_MAP.md reinforces its salience without needing a separate message.
    marker_based:
