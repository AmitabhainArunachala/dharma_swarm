...
improvement:
  room_for_improvement:
    - Group archive families if the subtree keeps expanding.
    - Keep archive metadata synchronized when top-level docs are demoted.
  next_review_at: '2026-04-03T12:00:00+09:00'
pkm:
  note_class: readme
  vault_path: docs/archive/README.md
  retrieval_terms:
    - docs
    - archive
    - historical
...
- retired duplicate families
- historical but still readable reference material
...
- if a prose file is still valuable but no longer deserves top-level or active authority, archive it here rather than leaving it mixed into current doctrine
