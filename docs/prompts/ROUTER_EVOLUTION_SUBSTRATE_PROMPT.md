---
title: ROUTER AS EVOLUTION SUBSTRATE — The Unexplored Edge
path: docs/prompts/ROUTER_EVOLUTION_SUBSTRATE_PROMPT.md
slug: router-as-evolution-substrate-the-unexplored-edge
doc_type: documentation
status: active
summary: 'Date : 2026-03-09 Context : Beyond cost optimization. Beyond failover. This is router as evolutionary substrate for agentic AI systems. Audience : System architects building 10+ year infrastructure Classification : SP...'
source:
...
- tests/test_context_compiler_cache.py
...
- tests.test_context_compiler_cache
...
pkm:
  ...
  vault_path: docs/prompts/ROUTER_EVOLUTION_SUBSTRATE_PROMPT.md
  retrieval_terms:
  - router
  - evolution
  - substrate
...
stigmergy:
  ...
  coordination_comment: 'Date : 2026-03-09 Context : Beyond cost optimization. Beyond failover. This is router as evolutionary substrate for agentic AI systems. Audience : System architects building 10+ year infrastructure Classification : SP...'
  levels:
    sematectonic:
      what_it_is: The document itself is the mark. Its existence, filename, location, and revision history attract or repel future work.
      access_mark: Opening, linking, and revising docs/prompts/ROUTER_EVOLUTION_SUBSTRATE_PROMPT.md reinforces its salience without needing a separate message.
    marker_based:
