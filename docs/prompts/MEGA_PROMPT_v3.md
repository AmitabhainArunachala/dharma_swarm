---
title: Mega Prompt v3 — Engineered
path: docs/prompts/MEGA_PROMPT_v3.md
slug: mega-prompt-v3-engineered
doc_type: note
status: active
summary: Engineering Notes (for Dhyana — don't paste this section)
source:
...
pkm:
  note_class: note
  vault_path: docs/prompts/MEGA_PROMPT_v3.md
  retrieval_terms:
  - mega
  - prompt
  - engineered
...
stigmergy:
  ...
  coordination_comment: Engineering Notes (for Dhyana — don't paste this section)
  levels:
    sematectonic:
      what_it_is: The document itself is the mark. Its existence, filename, location, and revision history attract or repel future work.
      access_mark: Opening, linking, and revising docs/prompts/MEGA_PROMPT_v3.md reinforces its salience without needing a separate message.
    marker_based:
