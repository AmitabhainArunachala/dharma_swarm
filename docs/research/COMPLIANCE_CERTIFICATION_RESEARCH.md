---
title: Compliance and Certification Systems for Safety-Critical AI
path: docs/research/COMPLIANCE_CERTIFICATION_RESEARCH.md
slug: compliance-and-certification-systems-for-safety-critical-ai
doc_type: documentation
status: active
summary: Compliance and Certification Systems for Safety-Critical AI Research Report for dharma swarm
source:
  provenance: repo_local
  kind: documentation
  origin_signals: []
  cited_urls:
  - https://www.knobbe.com/blog/navigating-regulatory-landscape-fda-approval-and-patent-protection-software-medical-device/
  - https://www.fda.gov/medical-devices/software-medical-device-samd/artificial-intelligence-software-medical-device
  - https://intuitionlabs.ai/articles/fda-ai-510k-submission-guidelines-best-practices
  - https://www.fdamap.com/valuable-insights/fda-510k-approval-a-real-world-guide-for-innovators-bringing-medical-devices-and-samd-to-market.html
  - https://510kfda.com/pages/fda-510k-costs
...
pkm:
  ...
  vault_path: docs/research/COMPLIANCE_CERTIFICATION_RESEARCH.md
  retrieval_terms:
  - compliance
  - certification
  - research
...
stigmergy:
  ...
  coordination_comment: Compliance and Certification Systems for Safety-Critical AI Research Report for dharma swarm
  levels:
    sematectonic:
      what_it_is: The document itself is the mark. Its existence, filename, location, and revision history attract or repel future work.
      access_mark: Opening, linking, and revising docs/research/COMPLIANCE_CERTIFICATION_RESEARCH.md reinforces its salience without needing a separate message.
    marker_based:
