...
from dharma_swarm.rv import RV_CONTRACTION_THRESHOLD, RVReading, _prompt_hash
...
class ResearchBridge:
    ...
    def compute_correlation(self) -> CorrelationResult:
        ...
        rv_values = [m.rv_reading.rv for m in paired]
        ...
        for group, members in sorted(groups.items()):
            mean_rv[group] = statistics.mean(
                m.rv_reading.rv for m in members
            )
