...
const sections: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Command Post", href: "/dashboard/command-post", icon: "BrainCircuit", level: 1 },
      ...
      { label: "Qwen Coder", href: "/dashboard/qwen35", icon: "Bot", level: 1 },
      { label: "Observatory", href: "/dashboard/observatory", icon: "HeartPulse", level: 1 },
